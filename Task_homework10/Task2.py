from Task1 import Mammal, Bird, Fish, Animal
...
def main():
    dog = AnimalFabric.build(animal_type='Mammal', name='Murka', age=5, voice='Meow!', hair='Red, shorthair')
    fish = AnimalFabric.build(animal_type='Fish', name='Smaylik', age=1, color='Gold')
    bird = AnimalFabric.build(animal_type='Bird', name='Gosha', age=8, color='Gray', voice='Tweet!')
    unidentified = AnimalFabric.build(animal_type='Non-type', name='Fail-Tester',                                      age=100, color='Green', voice='Boo', hair='blonde')
    print(dog.get_info(), '\n')
    print(fish.get_info(), '\n')
    print(bird.get_info(), '\n')
